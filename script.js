...
//238 managing workouts: creating classes
class Workout {
  date = new Date();
...
//const run1 = new Running([45, 45], 5.2, 24, 188);
//const cycle1 = new Cycling([45, 45], 27, 95, 552);
...
class App {
  ...
  _newWorkout(e) {
    ...
    //242 set local storage to all workouts
...
//233 Displaying a map using leaflet
//console.log(firstName);
//234 displaying map marker
